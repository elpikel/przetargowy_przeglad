...
#   - Ex: docker.io/hexpm/elixir:1.18.1-erlang-27.2-debian-trixie-20260112-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/przetargowy_przeglad ./
